...
/***/ function(module, exports, __webpack_require__) {
	...
	var Todo = function (_React$Component) {
	  ...
	  _createClass(Todo, [{
	    ...
	    key: 'modify',
	    value: function modify(i, e) {
	      _actions2.default.modify(i, e.target.value);
	    }
	  }, {
	    key: 'render',
	      ...
	      if (this.state.list) {
	        items = this.state.list.map(function (item, i) {
	          ...
	          return _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { type: 'text', ref: 'item2', onChange: _this2.modify.bind(_this2, i) })
	          );
	        });
	      }
	      return _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _reflux2.default.createStore({
	    ...
	    onModify: function onModify(i, item) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _reflux2.default.createActions(['getAll', 'add', 'remove', 'modify']);
